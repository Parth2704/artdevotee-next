...
import fa3h from "../../assets/images/fa3h.png";
import fa3 from "../../assets/images/fa3.png";
import fa4 from "../../assets/images/fa4.png";
import fa4h from "../../assets/images/fa4h.png";
import fa5 from "../../assets/images/fa5.png";
import fa5h from "../../assets/images/fa5h.png";
import fa6 from "../../assets/images/fa6.png";
import fa6h from "../../assets/images/fa6h.png";
import fa7 from "../../assets/images/fa7.png";
import fa7h from "../../assets/images/fa7h.png";
import btn_r8_arw from "../../assets/images/btn-r8-arw.png";
import heart_white from "../../assets/images/heart-white.png";
import bag_3 from "../../assets/images/bag-3.png";
              ...
              <div className="all_details_btns">
                {cartlist?.includes(JSON.stringify(data?.id)) && (
                  <a onClick={() => addCart(data)}>
                    Remove&nbsp;from&nbsp;Cart <Image src={de1} alt="" />
                  </a>
                )}
                {!cartlist?.includes(JSON.stringify(data?.id)) && (
                  <a onClick={() => addCart(data)}>
                    Add&nbsp;to&nbsp;Cart <Image src={de1} alt="" />
                  </a>
                )}
                <a className="blc_btns" onClick={() => openEnquiry(data?.slug)}>
                  Enquiry&nbsp;Now <Image src={de2} alt="" />
                </a>
                <a className="gree_btns" onClick={() => addCart(data, "buy")}>
                  Buy&nbsp;Now <Image src={de3} alt="" />
                </a>
              </div>
            </div>
              ...
              <div className="product_btms">
                ...
                <ul>
                  ...
                  >
                    <li>
                      <a>
                        <Image src={fa2} alt="" className="hvern" />
                        <Image src={fa1} alt="" className="hverb" />
                      </a>
                    </li>
                  </FacebookShareButton>
                  <TwitterShareButton
                  ...
                  >
                    <li>
                      <a>
                        <Image src={fa3h} alt="" className="hvern" />
                        <Image src={fa3} alt="" className="hverb" />
                      </a>
                    </li>
                  </TwitterShareButton>
                  <LinkedinShareButton
                  ...
                  >
                    <li>
                      <a>
                        <Image src={fa4} alt="" className="hvern" />
                        <Image src={fa4h} alt="" className="hverb" />
                      </a>
                    </li>
                  </LinkedinShareButton>
                  <WhatsappShareButton
                  ...
                  >
                    <li>
                      <a>
                        <Image src={fa5} alt="" className="hvern" />
                        <Image src={fa5h} alt="" className="hverb" />
                      </a>
                    </li>
                  </WhatsappShareButton>
                  <MailruShareButton
                  ...
                  >
                    <li>
                      <a>
                        <Image src={fa6} alt="" className="hvern" />
                        <Image src={fa6h} alt="" className="hverb" />
                      </a>
                    </li>
                  </MailruShareButton>
                  <TelegramShareButton
                  ...
                  >
                    <li>
                      <a>
                        <Image src={fa7} alt="" className="hvern" />
                        <Image src={fa7h} alt="" className="hverb" />
                      </a>
                    </li>
                  </TelegramShareButton>
                </ul>
